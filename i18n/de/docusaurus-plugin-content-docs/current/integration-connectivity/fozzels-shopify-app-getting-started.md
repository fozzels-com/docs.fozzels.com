---
id: '103000392433'
title: 2.3.1. Fozzels Shopify App — Erste Schritte
sidebar_position: 3
...
**Mit der Fozzels Shopify App können Sie:**

- Ihren Shopify-Shop in Minuten mit Fozzels verbinden – keine API-Schlüssel erforderlich
- Alle Ihre Produkte und deren Attribute automatisch in Fozzels abrufen
- Einzigartige Inhalte für jedes Produkt mit KI generieren
- Generierte Inhalte automatisch oder nach manueller Überprüfung mit Shopify synchronisieren
...
- einen Shopify-Shop (beliebiger Plan)
...
1. Klicken Sie auf **"Bei Fozzels anmelden"**
2. Geben Sie Ihre Fozzels-Konto-E-Mail und Ihr Passwort ein
3. Klicken Sie auf **Anmelden**

> Sie haben noch kein Fozzels-Konto? Klicken Sie auf **"Konto erstellen"**, um sich direkt von Shopify aus anzumelden.
...
1. Wählen Sie auf dem Bildschirm **Wählen Sie Ihre Integration** — **Shopify**
2. Füllen Sie das Integrationsformular aus:
    - **Name** — geben Sie Ihrer Integration einen erkennbaren Namen (z. B. "Mein Shopify Shop")
    - **URL** — geben Sie Ihre Shop-URL ein (z. B. `https://yourstore.myshopify.com`)
    - **Verbindungsmethode** — wählen Sie **Fozzels Shopify App (OAuth)** _(empfohlen)_
    - **App-Hostname** — geben Sie Ihren `.myshopify.com` Hostnamen ein (z. B. `yourstore.myshopify.com`)
3. Aktivieren Sie optional **Shopify Markets**, wenn Sie einen mehrsprachigen oder multireguionalen Shop betreiben
...
1. Öffnen Sie die **Fozzels App** im Shopify Admin
2. Klicken Sie auf **"Bei Fozzels anmelden"** und melden Sie sich an
3. Wählen Sie im Dialog **Shopify-Integration auswählen** — Ihre neu erstellte Integration
...
3. Klicken Sie auf **"Websites und Stores abrufen"**, um alle verfügbaren Märkte und Sprachen zu laden
4. Aktivieren Sie den Umschalter **Status** für die Shops, mit denen Sie arbeiten möchten
5. Klicken Sie auf **"Produkte abrufen"** für jeden Shop
6. Warten Sie, bis der Fortschrittsbalken **100%** erreicht
...
- Ihre Produkte im **Katalog** durchsuchen und filtern
- einen **Content Flow** erstellen, um KI-Beschreibungen, SEO-Titel und mehr zu generieren
- einen **Image Flow** einrichten, um professionelle Produktfotos mit KI zu generieren
- einen **Video Flow** verwenden, um Produktvideos automatisch zu erstellen

→ [Erfahren Sie, wie Sie Ihren ersten Content Flow erstellen](/content-creation-flows/creating-a-new-content-flow-and-initial-settings)
→ [Erfahren Sie mehr über Image Flows](https://fozzels.freshdesk.com/support/solutions/articles/103000369819-4-5-1-creating-a-new-image-flow-and-initial-settings-)

_Benötigen Sie Hilfe? Kontaktieren Sie uns unter [support@fozzels.com](mailto:support@fozzels.com)_
