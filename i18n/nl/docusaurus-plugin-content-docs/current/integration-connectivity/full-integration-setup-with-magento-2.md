...
description: >-
  In deze handleiding wordt gedetailleerd het proces beschreven van het tot
  stand brengen van een beveiligde tweerichtingsverbinding tussen uw Magento
  2-winkel en Fozzels. U zult de benodigde API
---
