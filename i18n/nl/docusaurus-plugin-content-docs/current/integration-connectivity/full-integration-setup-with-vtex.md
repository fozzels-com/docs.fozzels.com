...
description: >-
  Deze handleiding biedt stapsgewijze instructies voor het integreren van uw
  VTEX-winkelfront met Fozzels. Het proces omvat twee belangrijke stadia:
  genereren van de vereiste
---
