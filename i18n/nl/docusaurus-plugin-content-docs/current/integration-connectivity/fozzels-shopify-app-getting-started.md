---
id: '103000392433'
title: 2.3.1. Fozzels Shopify App — Aan de slag
sidebar_position: 3
slug: /integration-connectivity/fozzels-shopify-app-getting-started
description: >-
  Bedankt voor het installeren van de Fozzels Shopify App! We zijn enthousiast
  om u te helpen uw productinhoud te automatiseren en uren handmatig werk
  te besparen. Laten we u in slechts enkele minuten instellen.
---
...
**Met de Fozzels Shopify App kunt u:**

-   Uw Shopify-winkel in enkele minuten verbinden met Fozzels — geen API-sleutels vereist
-   Haal al uw producten en hun attributen automatisch in Fozzels
-   Genereer unieke inhoud voor elk product met AI
-   Synchroniseer gegenereerde inhoud automatisch of na handmatige beoordeling terug naar Shopify
...
1.  Klik **"Aanmelden bij Fozzels"**
2.  Voer uw e-mailadres en wachtwoord in voor uw Fozzels-account
3.  Klik **Aanmelden**

> Hebt u nog geen Fozzels-account? Klik **"Account maken"** om u rechtstreeks via Shopify aan te melden.
...
1.  Selecteer op het scherm **Kies uw integratie** — **Shopify**
2.  Vul het integratieformulier in:
    -   **Naam** — geef uw integratie een herkenbare naam (bijv. "Mijn Shopify-winkel")
    -   **URL** — voer uw winkel-URL in (bijv. `https://yourstore.myshopify.com`)
    -   **Verbindingsmethode** — selecteer **Fozzels Shopify App (OAuth)** _(aanbevolen)_
    -   **App-hostnaam** — voer uw `.myshopify.com`-hostnaam in (bijv. `yourstore.myshopify.com`)
3.  Schakel eventueel **Shopify Markets** in als u een meertalige of multiregio-winkel runt
4.  Klik **Opslaan**
...
1.  Open de **Fozzels-app** in Shopify Admin
2.  Klik **"Aanmelden bij Fozzels"** en meld u aan
3.  Selecteer in het dialoogvenster **Shopify-integratie selecteren** — uw nieuw gemaakte integratie
4.  Klik **Verbinden**
...
3.  Klik **"Pull Websites and Stores"** om alle beschikbare markten en talen te laden
4.  Schakel de **Statusschakelaar** in voor de winkels waarmee u wilt werken
5.  Klik **"Pull Products"** voor elke winkel
6.  Wacht tot de voortgangsbalk **100%** bereikt
...
-   Bladeren door en filtert u uw producten in de **Catalogus**
-   Maak een **Content Flow** om AI-beschrijvingen, SEO-titels en meer te genereren
-   Stel een **Image Flow** in om professionele productfoto's automatisch met AI te genereren
