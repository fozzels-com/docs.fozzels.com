...
![](/img/kb/account-core-resources/how-to-set-up-auto-top-up-and-add-or-change-your-default-payment-method-card-in-/ykFZow4_tbnd9qA8tX-V2L5Uoyr8pyXtlQ.png)
 ...
 ![botão de marca de verificação](/img/kb/account-core-resources/how-to-set-up-auto-top-up-and-add-or-change-your-default-payment-method-card-in-/path.png) Usar como método de pagamento padrão - Esta caixa de seleção aparecerá para cada cartão adicionado após o primeiro. Ela é marcada por padrão. Mantenha esta caixa marcada para tornar o novo cartão a prioridade para todos os pagamentos futuros, substituindo o cartão Padrão atual.
