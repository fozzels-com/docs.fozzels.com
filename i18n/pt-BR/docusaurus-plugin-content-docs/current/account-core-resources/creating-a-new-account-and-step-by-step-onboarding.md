...
Após verificar seu e-mail, você será redirecionado para a tela de Boas-vindas, onde começa a Lista de Verificação de Onboarding essencial de 6 etapas. Sua conta está **totalmente ativada** apenas após a conclusão de todas as 6 etapas.
...
-   Para instruções passo a passo sobre como conectar sua loja ou PIM, leia mais [aqui](/integration-connectivity).

4.  **Adicione um pequeno saldo para uso de tokens de IA:** Navegue até Configurações de Pagamento e clique no botão **"Carregar Agora"** para recarregar sua conta.
**Nota:** Um saldo positivo é necessário para gerar conteúdo, pois o uso de tokens é cobrado de acordo com seu plano e modelo de IA selecionado.

-   Para detalhes sobre como gerenciar seu saldo, métodos de pagamento e configurações de recarga automática, leia mais aqui.

5.  **Crie seu primeiro Fluxo:** Projete seu cenário de geração de conteúdo (Fluxo). Você pode começar a partir de um modelo ou personalizá-lo completamente (idioma, tom, estrutura, etc.).

-   Para um guia completo sobre como criar, configurar e testar seu primeiro fluxo de conteúdo, leia mais [aqui](/content-creation-flows).

6.  **Inicie o Fluxo e comece a sincronizar de volta para sua loja online:** Lance seu Fluxo. Uma vez em execução e com sua integração ativa, os textos gerados serão sincronizados automaticamente com sua loja ou PIM.
