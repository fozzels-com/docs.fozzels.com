...
-   Checkbox Individual: Localizado no início de cada linha para selecionar um único produto.
...
-   Selecionar Tudo: Escolha esta função para selecionar **todos** os produtos no Catálogo que correspondem aos filtros atuais, independentemente da página.

-   Desselecionar Tudo: Limpa a seleção em todo o Catálogo.

-   Selecionar Tudo nesta Página: Seleciona apenas os produtos atualmente exibidos na página atual.
...
1\. Mostrar Selecionados

Clique em **"Show Selected"** para isolar os itens escolhidos em uma tabela separada, criando um espaço de trabalho focado. Isto é altamente conveniente para:

-   Verificação: Confirmar rapidamente que o conjunto correto de produtos foi selecionado.
