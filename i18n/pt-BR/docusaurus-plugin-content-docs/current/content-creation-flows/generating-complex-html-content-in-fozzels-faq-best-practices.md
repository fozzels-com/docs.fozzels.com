...
description: >-
  Gerando conteúdo HTML complexo no Fozzels: boas práticas. O Fozzels pode gerar
  não apenas descrições de produto padrão, mas também conteúdos mais complexos
---
