...
description: >-
  O recurso de Fluxo de Vídeo é um Fluxo de Conteúdo especializado dedicado à
  geração de ativos de vídeo de alta fidelidade para apresentação de produtos.
  Criando um Fluxo de Vídeo
---
