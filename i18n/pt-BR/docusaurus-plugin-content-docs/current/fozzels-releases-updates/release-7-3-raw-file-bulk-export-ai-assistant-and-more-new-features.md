---
id: '103000406495'
title: 'Release 7.3 Arquivo Bruto, Exportação em Massa, Assistente de IA e Mais Novos Recursos'
sidebar_position: 13
slug: >-
  /fozzels-releases-updates/release-7-3-raw-file-bulk-export-ai-assistant-and-more-new-features
description: >-
  Esta versão é tudo sobre poder, flexibilidade e controle absoluto sobre seu catálogo. Adicionamos integrações de arquivo manual tão esperadas, expandimos filtragem inteligente para novos ecossistemas
---
...
## Integração CSV Nativa (Arquivo Bruto)
Estamos derrubando as barreiras entre plataformas. Se sua plataforma de e-commerce ou CMS personalizado não tiver uma integração direta com o Fozzels, você pode agora conectar seu catálogo usando arquivos de dados padrão.

-   Independência de Plataforma: Exporte seu catálogo de produtos como arquivo CSV e carregue-o diretamente no Fozzels usando o novo tipo de integração Raw File.
-   Mapeamento Automático de Campo: O sistema processa a estrutura do arquivo dinamicamente, transformando cada linha em um produto distinto e mapeando colunas para atributos únicos.
...
-   Arquivamento Tudo em Um: Empacote todo seu texto de produto gerado, imagens em alta resolução e ativos de vídeo pesado em arquivos ZIP estruturados com um único clique.
-   Nomenclatura de Arquivo Baseada em Nome: Os arquivos dentro do arquivo são automaticamente nomeados após seus nomes de produto respectivos, tornando a correspondência manual e uploads de plataforma cruzada completamente descomplicados.
-   Processamento em Segundo Plano: Grandes exportações de geração executam silenciosamente em segundo plano, permitindo que você navegue livremente no Fozzels enquanto o sistema constrói seu arquivo.
-   Armazenamento em Nuvem & Notificações: Uma vez que o trabalho de compilação for concluído, o arquivo ZIP é armazenado com segurança e você recebe uma notificação de sistema instantânea contendo um link de download direto.
