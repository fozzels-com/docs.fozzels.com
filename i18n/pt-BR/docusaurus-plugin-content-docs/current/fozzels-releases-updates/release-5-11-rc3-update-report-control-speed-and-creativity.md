---
id: '103000382981'
title: 'Versão 5.11 RC3: Relatório de Atualização. Controle, Velocidade e Criatividade'
sidebar_position: 2
slug: /fozzels-releases-updates/release-5-11-rc3-update-report-control-speed-and-creativity
description: Estamos entusiasmados em apresentar a Versão 5.11RC3 — nossa maior atualização focada em aumentar sua produtividade, confiabilidade de dados e, mais importante, liberdade criativa.
---
...
1.  Ressincronização Instantânea de Conteúdo (Resync)
...
Introduzimos um novo filtro automático que garante a "limpeza" de todo o conteúdo gerado. Isso exclui todas as entidades HTML ocultas que possam ter permanecido no texto, garantindo a mais alta qualidade e minimizando preocupações relacionadas a SEO ou pureza de código.
...
3.  Gerenciamento Completo de Tags HTML (Controle de Conteúdo Criativo)
...
4.  Gerenciamento Inteligente de Multi-Loja
...
Sem mais atualizações de Fluxo manuais! O Fozzels agora atualiza automaticamente a contagem de produtos em todos os seus Fluxos imediatamente após cada Pull de Produto, independentemente de ser manual ou automático.

Onde encontrar: Todos os seus Fluxos existentes.

7.  Controle Aprimorado de "Evitar Sobreposição"

Fornecemos a você máxima flexibilidade na geração! Você pode definir um período global de prevenção de duplicação (por exemplo, 1 mês) e, em seguida, substituir esse valor para um Fluxo específico (por exemplo, definir 1 semana) ou desabilitar essa regra totalmente.
...
8.  Suporte Multilíngue e Notificações por Email
...
Removemos o bloqueio de registro imposto pela verificação obrigatória de Email. Você pode criar uma conta, pagar e começar a trabalhar imediatamente. Lembramos você sobre a verificação mais tarde.
...
Continuamos trabalhando para tornar o Fozzels a melhor ferramenta para conteúdo de e-commerce. Obrigado por estar conosco!
