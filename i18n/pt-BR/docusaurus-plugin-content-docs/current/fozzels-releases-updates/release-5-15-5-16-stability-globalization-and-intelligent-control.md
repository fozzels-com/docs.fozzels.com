---
id: '103000395550'
title: Release 5.15 & 5.16 - Estabilidade, Globalização e Controle Inteligente
sidebar_position: 8
slug: /fozzels-releases-updates/release-5-15-5-16-stability-globalization-and-intelligent-control
description: Combinamos duas grandes atualizações para tornar seu fluxo de trabalho de conteúdo mais confiável e suas capacidades de sincronização ilimitadas. Globalização & Excelência em SEO
---

Combinamos duas grandes atualizações para tornar seu fluxo de trabalho de conteúdo mais confiável e suas capacidades de sincronização ilimitadas.

## Globalização & Excelência em SEO

-   **Localização de Metafields do Shopify (v5.16):** Agora você pode gerar e sincronizar **Metafields** baseados em texto para **Shopify Markets** e **Langshop**. Isso cobre as lojas padrão e traduções para idiomas adicionais.

-   **Correção: Redefinição de Meta Title do SEO (v5.15):** Resolvemos um problema em que os Meta Titles poderiam ser redefinidos para seus valores originais. Seus títulos SEO otimizados agora são salvos com segurança em todos os mercados e idiomas.

-   **Shopify SEO Guard (v5.16):** Para evitar inconsistências de dados, o sistema agora restringe a sincronização padrão de campos de SEO para lojas não padrão (devido à arquitetura da API do Shopify).

-   **Conformidade da API do Shopify:** Nossos aplicativos foram totalmente atualizados para atender aos requisitos mais recentes do Shopify. **Observação:** Se você recebeu um e-mail sobre o prazo de **1º de abril de 2026** - não se preocupe, já cuidamos disso. Tudo está configurado para operação estável.

## WooCommerce: Diagnóstico Inteligente (v5.16)

A configuração de integração agora é transparente e à prova de erros:

-   **Diagnóstico de Conexão:** Verificação automática de credenciais de API e permissões sempre que você salva.

-   **Verificação de Status do Plugin:** Fozzels agora detecta se **ACF, Yoast SEO, AIOSEO ou WPML** estão ativos e configurados corretamente.

-   **Detecção de Conflito:** O sistema avisa se vários plugins de SEO estão ativos simultaneamente para evitar erros de sincronização.

-   **Alertas de Conector Desatualizado:** Seja notificado se seu plugin do conector Fozzels precisar ser atualizado, com um link de download direto fornecido.
...
## Potência da IA & Qualidade do Conteúdo (v5.16)
