...
description: >-
  Este guia detalha o processo de estabelecimento de uma conexão segura e
  bidirecional entre sua loja Magento 2 e Fozzels. Você gerará os Tokens de API
---
...
1.  Solicite a lista atual de endereços IP do Fozzels em **[support@fozzels.com](mailto:support@fozzels.com)**.
    Para adicionar à whitelist, você pode usar o endereço IP Fozzels:
**49.13.117.118**
...
4.  **Leia** mais sobre trabalhar com atributos de produtos e personalizar campos de dados [aqui](https://fozzels.freshdesk.com/a/solutions/articles/103000368952).
