...
description: >-
  O que é Integração CSV? A integração CSV permite conectar seu catálogo de produtos
  ao Fozzels usando um arquivo CSV padrão. Se sua plataforma não tiver uma
---
