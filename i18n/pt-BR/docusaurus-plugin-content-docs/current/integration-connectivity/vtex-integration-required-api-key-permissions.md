...
description: Quais permissões de chave de API preciso para conectar Fozzels ao VTEX? Para conectar sua loja VTEX ao Fozzels, você precisa criar uma chave de API em seu admin VTEX e
---
