...
description: >-
  Las Plantillas de Indicaciones son modelos de texto reutilizables y
  preconfigurados utilizados como entrada para que la IA genere tipos
  específicos de contenido de productos. Estas plantillas están confi
---
