---
id: '103000382981'
title: 'Release 5.11 RC3: Update Report. Control, Speed, and Creativity'
sidebar_position: 2
slug: >-
  /fozzels-releases-updates/release-5-11-rc3-update-report-control-speed-and-creativity
description: >-
  We are excited to introduce Release 5.11RC3 — our biggest update focused on
  boosting your productivity, data reliability, and, most importantly, creative
  f
---
...
1.  Instant Content Resynchronization (Resync)
...
2.  Always Clean AI Output
    ...
    We have introduced a new automatic filter that guarantees the "cleanliness" of all generated content. This excludes all hidden HTML entities that might have remained in the text, ensuring the highest quality and minimizing concerns regarding SEO or code purity.
...
3.  Full HTML Tag Management (Creative Content Control)
...
4.  Smart Multi-Store Management
...
6.  Automatic Flow Update After Pull
    ...
    No more manual Flow updates! Fozzels now automatically updates the product count in all your Flows immediately after every Product Pull, regardless of whether it is manual or automatic.

        Where to find: All your existing Flows.

7.  Enhanced "Prevent Overlapping" Control

    We have given you maximum flexibility in generation! You can set a global duplication prevention period (e.g., 1 month), and then override this value for a specific Flow (e.g., set 1 week) or disable this rule entirely.
...
8.  Multilingual Support and Email Notifications
...
9.  Instant Start
    ...
    We have removed the registration block imposed by mandatory Email verification. You can create an account, pay, and start working immediately. We will remind you about verification later.
...
We continue to work to make Fozzels the best tool for e-commerce content. Thank you for being with us!
