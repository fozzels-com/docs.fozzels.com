...
1.  Request the current list of Fozzels IP addresses from **[support@fozzels.com](mailto:support@fozzels.com)**.
    For whitelisting, you can use the Fozzels IP address:
**49.13.117.118**
...
4.  **Read** more about working with product attributes and customizing data fields [here](https://fozzels.freshdesk.com/a/solutions/articles/103000368952).
