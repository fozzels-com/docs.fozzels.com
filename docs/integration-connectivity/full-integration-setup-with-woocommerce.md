...
3\. Click the "**Pull products**" button for each necessary store. This action initiates the initial load of product data into Fozzels. Read more about pulling products [here](/content-creation-flows/when-do-new-products-get-generated-the-pull-cycle-explained/).
