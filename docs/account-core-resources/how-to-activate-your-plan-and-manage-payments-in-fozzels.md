---
id: '103000395552'
title: 1.3.1. How to Activate Your Plan and Manage Payments in Fozzels
sidebar_position: 4
slug: >-
  /account-core-resources/how-to-activate-your-plan-and-manage-payments-in-fozzels
description: >-
  Welcome to Fozzels! To unlock the full potential of our AI without limits, you
  need to activate a subscription. Here is your step-by-step guide. 1. Choose
---

Welcome to Fozzels! To unlock the full potential of our AI without limits, you need to activate a subscription. Here is your step-by-step guide.
...
-   **As an Individual:** Enter your card details, email, and billing address.
...
-   **Status:** Go to **Settings -> Billing -> Subscription**. Your plan should now show a green **active** label.
...
To ensure your service remains uninterrupted next month, set your card as the primary method:

1.  In the **Payments** tab, click the orange **Customer Billing Portal** button.
...
1.  Click the green **Charge Credit Now** button in the **Payments** section.

2.  Enter the amount (e.g., €50) in the pop-up.

3.  You will be redirected to Stripe to confirm.

4.  Put your data into the inputs and hit **Pay**.
